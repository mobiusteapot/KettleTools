...
namespace BennyKok.NotionAPI
{
    public class NotionAPI
    {
        ...
        // notion version for authentication, not for link injection
        private readonly static string notionVersion = "2022-06-28";
        private readonly static string rootUrl = $"https://api.notion.com/{version}";
        private readonly static string urlBlock = rootUrl + "/blocks";
        ...
        private UnityWebRequest WebRequestWithAuth(string url, RequestType requestType, WWWForm form = null)
        {
            ...
            request.SetRequestHeader("Notion-Version", notionVersion);
        ...
        {
            var url = $"{urlBlock}/{database_id}/query";
