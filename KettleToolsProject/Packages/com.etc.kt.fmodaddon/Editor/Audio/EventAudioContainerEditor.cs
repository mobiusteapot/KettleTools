...
{
    [CustomEditor(typeof(EventAudioContainer))]
    [CanEditMultipleObjects]
    public class EventAudioContainerEditor : Editor
    {
...
// {
    ...
    //     {
    //         var emitter = target as KTEventEmitter;
    ...
    //     {
    //         var eventAudioContainer = serializedObject.FindProperty("eventAudioContainer");
    //         var useGameEvents = serializedObject.FindProperty("UseGameEvents");
    ...
    //         IMGUIStaticExtensions.ConditionalPropertyField(useGameEvents.boolValue, new (begin, end));
    ...
    //             foreach (SerializedObject serializedTarget in serializedTargets)
    //             {
    //                 KTEventEmitter emitter = serializedTarget.targetObject as KTEventEmitter;
